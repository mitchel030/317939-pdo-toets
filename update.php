      ...
      <div class=col-6>
         <form action="./update_script.php" method="post">
            <div class="mb-3">
               ...
               <select class="form-control" type="text" name="bodemformaat" id="inputBodemFormaat" value="<?=$pizz->bodemformaat; ?>">
                  <option>20 cm</option>
            ...
            <div class="mb-3">
               ...
               <select class="form-control"   type="text"   name="saus"    id="inputSaus" value="<?=$pizz->saus; ?>">
            ...
            <div class="mb-3">
               ...
               <input class="form-control" type="text" name="pizzatoppings" id="inputPizzatoppings" value="">
            </div>
            <div class="mb-3">
               <label for="inputKruiden" class="form-label">Kruiden</label>
               <input class="form-control" type="text" name="kruiden" id="inputKruiden" value="">
            </div>
            <div class="mb-3">
